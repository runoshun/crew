...
var (
	...
	ErrInvalidSkipReview           = errors.New("invalid skip_review value")
	...
	ErrNoReviewComment             = errors.New("reviewer did not output a review result")
	ErrInvalidACPCommand           = errors.New("invalid ACP command")
	ErrACPStateNotFound            = errors.New("acp state not found")
	ErrInvalidACPExecutionSubstate = errors.New("invalid acp execution substate")
